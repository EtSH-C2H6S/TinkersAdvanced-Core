...
* Materials
  ...
  * Iridium
    > Tier 5 material, a material found in The End dimension in small quantities. Has a high stat and capable of clearing harmful effects.
...
* Original Materials
  ...
  * Activated Chromatic Steel
    > Top-rated Thermal compat material, Tier 5. Includes a series of powerful flux based modifiers. Crafted by alloying Basalz Signalum, Blitz Lumium, Blizz Enderium and Blaze Netherite.
* Fuels
  * Pyrotheum
 ...
 * Original Materials
   * Irradium
     > Tier 5 material that resembles Irradium from Frackin's Universe mod (Starbound). Crafted by combining Pellet Polonium and Manyullyn Ingot. Inflicts radiation to enemy and adds glowing effect.
   * Densium
     > Tier 5 material that resembles Densium from Frackin's Universe mod (Starbound). Crafted by alloying Molten Iridium, Molten Osmium and Molten Refined Obsidian. Slightly increase stats and contains some functional traits.
   * Protocite
     > Tier 5 material that resembles Protocite from Frackin's Universe mod (Starbound). Crafted by combining Pellet Plutonium and Hepatizon Ingot.
 ...
 * Fuels
   * Molten Antimatter
     > 32767℃ Fuel, but very expensive. Pellet antimatter counts as slimeball and each pellets melts into 250 mB Molten Antimatter.
 * Modifiers
   * Atom Grade
